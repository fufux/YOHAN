...
void Tetrahedron::fillMatrix2(SquareSparseMatrix* K, SquareSparseMatrix* M, DATA* F, DATA gravity[])
{
	// point information
...
void Tetrahedron::fillMatrix(SquareSparseMatrix* K, SquareSparseMatrix* M, DATA* F, DATA gravity[])
{
	...
	// ai = xj*ym*zp - xj*yp*zm - xm*yj*zp + xm*yp*zj + xp*yj*zm - xp*ym*zj
	a[0] = p1[0 + 6] * p2[1 + 6] * p3[2 + 6] - 
		 p1[0 + 6] * p3[1 + 6] * p2[2 + 6] - 
		 p2[0 + 6] * p1[1 + 6] * p3[2 + 6] + 
		 p2[0 + 6] * p3[1 + 6] * p1[2 + 6] + 
		 p3[0 + 6] * p1[1 + 6] * p2[2 + 6] - 
		 p3[0 + 6] * p2[1 + 6] * p1[2 + 6];

	a[1] = p2[0 + 6] * p3[1 + 6] * p0[2 + 6] - 
		 p2[0 + 6] * p0[1 + 6] * p3[2 + 6] - 
		 p3[0 + 6] * p2[1 + 6] * p0[2 + 6] + 
		 p3[0 + 6] * p0[1 + 6] * p2[2 + 6] + 
		 p0[0 + 6] * p2[1 + 6] * p3[2 + 6] - 
		 p0[0 + 6] * p3[1 + 6] * p2[2 + 6];

	a[2] = p3[0 + 6] * p0[1 + 6] * p1[2 + 6] - 
		 p3[0 + 6] * p1[1 + 6] * p0[2 + 6] - 
		 p0[0 + 6] * p3[1 + 6] * p1[2 + 6] + 
		 p0[0 + 6] * p1[1 + 6] * p3[2 + 6] + 
		 p1[0 + 6] * p3[1 + 6] * p0[2 + 6] - 
		 p1[0 + 6] * p0[1 + 6] * p3[2 + 6];

	a[3] = p0[0 + 6] * p1[1 + 6] * p2[2 + 6] - 
		 p0[0 + 6] * p2[1 + 6] * p1[2 + 6] - 
		 p1[0 + 6] * p0[1 + 6] * p2[2 + 6] + 
		 p1[0 + 6] * p2[1 + 6] * p0[2 + 6] + 
		 p2[0 + 6] * p0[1 + 6] * p1[2 + 6] - 
		 p2[0 + 6] * p1[1 + 6] * p0[2 + 6];

	// i-0 j-1 m-2 p-3

	// bi = -ym*zp + yp*zm + yj*zp - yp*zj - yj*zm + ym*zj
	b[0] = - p2[1 + 6] * p3[2 + 6] + p3[1 + 6] * p2[2 + 6] +
		   p1[1 + 6] * p3[2 + 6] - p3[1 + 6] * p1[2 + 6] -
		   p1[1 + 6] * p2[2 + 6] - p2[1 + 6] * p1[2 + 6];

	b[1] = - p3[1 + 6] * p0[2 + 6] + p0[1 + 6] * p3[2 + 6] +
		   p2[1 + 6] * p0[2 + 6] - p0[1 + 6] * p2[2 + 6] -
		   p2[1 + 6] * p3[2 + 6] - p3[1 + 6] * p2[2 + 6];

	b[2] = - p0[1 + 6] * p1[2 + 6] + p1[1 + 6] * p0[2 + 6] +
		   p3[1 + 6] * p1[2 + 6] - p1[1 + 6] * p3[2 + 6] -
		   p3[1 + 6] * p0[2 + 6] - p0[1 + 6] * p3[2 + 6];

	b[3] = - p1[1 + 6] * p2[2 + 6] + p2[1 + 6] * p1[2 + 6] +
		   p0[1 + 6] * p2[2 + 6] - p2[1 + 6] * p0[2 + 6] -
		   p0[1 + 6] * p1[2 + 6] - p1[1 + 6] * p0[2 + 6];

	// i-0 j-1 m-2 p-3

	// ci = xm*zp - xp*zm - xj*zp + xp*zj + xj*zm - xm*zj
	c[0] = p2[0 + 6] * p3[2 + 6] - p3[0 + 6] * p2[2 + 6] -
		 p1[0 + 6] * p3[2 + 6] + p3[0 + 6] * p1[2 + 6] +
		 p1[0 + 6] * p2[2 + 6] - p2[0 + 6] * p1[2 + 6];

	c[1] = p3[0 + 6] * p0[2 + 6] - p0[0 + 6] * p3[2 + 6] -
		 p2[0 + 6] * p0[2 + 6] + p0[0 + 6] * p2[2 + 6] +
		 p2[0 + 6] * p3[2 + 6] - p3[0 + 6] * p2[2 + 6];

	c[2] = p0[0 + 6] * p1[2 + 6] - p1[0 + 6] * p0[2 + 6] -
		 p3[0 + 6] * p1[2 + 6] + p1[0 + 6] * p3[2 + 6] +
		 p3[0 + 6] * p0[2 + 6] - p0[0 + 6] * p3[2 + 6];

	c[3] = p1[0 + 6] * p2[2 + 6] - p2[0 + 6] * p1[2 + 6] -
		 p0[0 + 6] * p2[2 + 6] + p2[0 + 6] * p0[2 + 6] +
		 p0[0 + 6] * p1[2 + 6] - p1[0 + 6] * p0[2 + 6];

	// i-0 j-1 m-2 p-3

	// di = -xm*yp + xp*ym + xj*yp - xp*yj - xj*ym + xm*yj
	d[0] = - p2[0 + 6] * p3[1 + 6] + p3[0 + 6] * p2[1 + 6] +
		   p1[0 + 6] * p3[1 + 6] - p3[0 + 6] * p1[1 + 6] -
		   p1[0 + 6] * p2[1 + 6] + p2[0 + 6] * p1[1 + 6];

	d[1] = - p3[0 + 6] * p0[1 + 6] + p0[0 + 6] * p3[1 + 6] +
		   p2[0 + 6] * p0[1 + 6] - p0[0 + 6] * p2[1 + 6] -
		   p2[0 + 6] * p3[1 + 6] + p3[0 + 6] * p2[1 + 6];

	d[2] = - p0[0 + 6] * p1[1 + 6] + p1[0 + 6] * p0[1 + 6] +
		   p3[0 + 6] * p1[1 + 6] - p1[0 + 6] * p3[1 + 6] -
		   p3[0 + 6] * p0[1 + 6] + p0[0 + 6] * p3[1 + 6];

	d[3] = - p1[0 + 6] * p2[1 + 6] + p2[0 + 6] * p1[1 + 6] +
		   p0[0 + 6] * p2[1 + 6] - p2[0 + 6] * p0[1 + 6] -
		   p0[0 + 6] * p1[1 + 6] + p1[0 + 6] * p0[1 + 6];
	...
	/* 6V = xj*ym*zp - xj*zm*yp - xm*yj*zp + xm*zj*yp + 
			...
			xj*yi*zm - xj*zi*ym - xm*yi*zj + xm*zi*yj 
	*/
	vol6 = p1[0 + 6] * p2[1 + 6] * p3[2 + 6] - p1[0 + 6] * p2[2 + 6] * p3[1 + 6] + p2[0 + 6] * p1[1 + 6] * p3[2 + 6] + p2[0 + 6] * p1[2 + 6] * p3[1 + 6] +
		   p3[0 + 6] * p1[1 + 6] * p2[2 + 6] - p3[0 + 6] * p1[2 + 6] * p2[1 + 6] - p0[0 + 6] * p2[1 + 6] * p3[2 + 6] + p0[0 + 6] * p2[2 + 6] * p3[1 + 6] +
		   p2[0 + 6] * p0[1 + 6] * p3[2 + 6] - p2[0 + 6] * p0[2 + 6] * p3[1 + 6] - p3[0 + 6] * p0[1 + 6] * p2[2 + 6] + p3[0 + 6] * p0[2 + 6] * p2[1 + 6] +
		   p0[0 + 6] * p1[1 + 6] * p3[2 + 6] - p0[0 + 6] * p1[2 + 6] * p3[1 + 6] - p1[0 + 6] * p0[1 + 6] * p3[2 + 6] + p1[0 + 6] * p0[2 + 6] * p3[1 + 6] +
		   p3[0 + 6] * p0[1 + 6] * p1[2 + 6] - p3[0 + 6] * p0[2 + 6] * p1[1 + 6] - p0[0 + 6] * p1[1 + 6] * p2[2 + 6] + p0[0 + 6] * p1[2 + 6] * p2[1 + 6] +
		   p1[0 + 6] * p0[1 + 6] * p2[2 + 6] - p1[0 + 6] * p0[2 + 6] * p2[1 + 6] - p2[0 + 6] * p0[1 + 6] * p1[2 + 6] + p2[0 + 6] * p0[2 + 6] * p1[1 + 6];
