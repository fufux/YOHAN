...
int main(int argc, _TCHAR* argv[])
{
	...
	*/
	IAnimatedMesh* mesh = smgr->getMesh("irrlicht/media/dwarf.x");

	/*
	For testing the APIs of IAnimatedMesh
	*/
	mesh->
	...
	*/
	if (node)
	{
		...
		node->setMaterialTexture( 0, driver->getTexture("irrlicht/media/dwarf.jpg") );
	}
	...
	*/
	smgr->addCameraSceneNode(0, vector3df(0,60,-80), vector3df(0,15,0));
